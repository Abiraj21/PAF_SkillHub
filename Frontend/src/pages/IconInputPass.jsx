...
export default function IconInputPass({children,placeholder,text,value, onChange}){
    ...
    return(
      <div className='flex justify-left items-center w-full h-10 shadow mt-4'>
        ...
        <input type={text} placeholder={placeholder} className='w-full h-full pl-14' value={value} onChange={onChange}/>
      </div>
    )
  }