...
import {
  ...
  faImage,
  faUserPlus,
  faTimes,faUtensils, faPlus,faBookOpen
        ...
        <div className="w-1/5 p-4 bg-gray-100 h-screen sticky top-0">
                ...
                <div className="mt-6 space-y-4">
                  <div className="flex items-center space-x-2">
                    <FontAwesomeIcon icon={faUserFriends} className="text-blue-500" />
                  ...
                  <Link to="/recipe"><div className="flex items-center space-x-2 mt-2 cursor-pointer">
